...
export const H3: FC<HeadingProps> = ({ className, children, ...props }) => (
  <h3 className={clsx("text-2xl mb-8 mt-14", className)} {...props}>
    {children}
  </h3>
);

export const H4: FC<HeadingProps> = ({ className, children, ...props }) => (
  <h4 className={clsx("text-xl mb-8 mt-14", className)} {...props}>
    {children}
  </h4>
);

export const H5: FC<HeadingProps> = ({ className, children, ...props }) => (
  <h5 className={clsx("text-lg mb-8 mt-14", className)} {...props}>
    {children}
  </h5>
);

export const H6: FC<HeadingProps> = ({ className, children, ...props }) => (
  <h6 className={clsx("text-base mb-8 mt-14", className)} {...props}>
    {children}
  </h6>
);
