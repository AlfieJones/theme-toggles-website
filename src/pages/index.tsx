...
const Home = ({ toggles }: any) => (
  <>
    <NextSeo description="A Collection of dark and light theme toggles, built with SVG's driven by CSS transitions. This dark mode switches library comes with official React support" />
