...
The follow example shows how you can provide your own state
 ```jsx
...
## Toggles
Find the full range of toggles <Link href="/"><a className="text-blue-500">here</a></Link>. The React code can be found via the upper tab when on a toggles page
